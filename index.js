...
const routers = {
  ...
  "/api/Exports": "./routes/exports/exportRouter.js",
...
app.use(express.static(path.join(__dirname, "../archive-project-main/build")));

app.get("*", (req, res) => {
  res.sendFile(
    path.join(__dirname, "../archive-project-main/build", "index.html")
  );
});
// API Routes Ends
// 404 Handler
