...
const translations = {
  ...
  KU: {
    ...
    source_high: "Hatiye Piştrastkirin",
    source_low: "Nehatiye Piştrastkirin",
    source_medium: "Heya Astekê Hatiye Piştrastkirin",
    high: "Cihê Baweriyê ye",
    medium: "Heya Astekê Tê Bawerkirin",
    low: "Ne Cihê Baweriyê ye",
    observation: "Nerîn",
    note: "Têbînî",
    details: "Hûr",
    opinion: "Nerîn",
  ...
  AR: {
    ...
    source_high: "محل ثقة",
    source_low: "غير موثوق",
    source_medium: "موثوق إلى حد ما",
    high: "عالي",
    medium: "متوسط",
    low: "منخفض",
  ...
  TU: {
    ...
    medium: "",
    low: "",
    source_credibility: "Müstahdem kaynak",
    observation: "Gözlem",
    note: "Not",
    details: "Ayrıntılar",
    opinion: "Görüş",
